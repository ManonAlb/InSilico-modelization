...
if len(sys.argv) != 2:
    print(f"too much or too litle arguments ! ({len(sys.argv)} != 2)")
else:
    explor_path = sys.argv[1]
    print(f"exploring directory in {explor_path}")

    diffracto(explor_path, 1)
