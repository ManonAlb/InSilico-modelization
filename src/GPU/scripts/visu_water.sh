...
#SBATCH --job-name=visualization_water                  #This is the name of your job
...
#SBATCH --time=20:00:00        #This is the time that your task will run
#SBATCH --qos=1day           #You will run in this queue

# Paths to STDOUT or STDERR files should be absolute or relative to current working directory
#SBATCH --output=output4_errors     #This is the joined STDOUT and STDERR file
...
echo "running python visu_water.py ${DIR_PATH}"
python visu_water.py "${DIR_PATH}"
