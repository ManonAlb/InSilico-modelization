...
#SBATCH --job-name=diffraction_protein                  #This is the name of your job
...
#SBATCH --output=output2_errors     #This is the joined STDOUT and STDERR file
